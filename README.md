...
> :information_source: Rode os serviços `mysql_service` e `back_service` e `front_service`  com o comando `docker-compose up -d`.
...
- Esses serviços irão inicializar um container chamado `estoque_db`, `estoque_back`  e outro chamado `estoque_front`;
 ...
 [
	...
	},
	{
		"id" : 4,
		"usuario" : "barbie",
		"senha" : "$2b$12$WJJk7rUZ8SooOEkTCLkZD.WK/iSE2wCHpfXJiAbNza0smjkif./NW"
	},
	{
		"id" : 5,
		"usuario" : "oppenbarbie",
