...
def seed(db):
    try:
        ...
        if seeded is None:
            ...
            db.add_all(produtos)
            vendas = [
                VendaModel(produto_id=1, quantidade=1, usuario_id=1, data_venda="2023-07-25T13:50:54"),
                VendaModel(produto_id=3, quantidade=10, usuario_id=2, data_venda="2023-07-25T13:50:54"),
                VendaModel(produto_id=5, quantidade=5, usuario_id=3, data_venda="2023-07-25T13:50:54"),
                VendaModel(produto_id=6, quantidade=3, usuario_id=4, data_venda="2023-07-25T13:50:54"),
                VendaModel(produto_id=8, quantidade=2, usuario_id=5, data_venda="2023-07-25T13:50:54"),
            ]
            db.add_all(vendas)
            db.commit()
            print("Seed efetuado")
